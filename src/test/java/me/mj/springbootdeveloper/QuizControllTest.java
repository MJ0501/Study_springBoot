...
class QuizControllTest {
    ...
    @DisplayName("quiz(): GET /quiz?code=1 이면 응답코드=201, 응답본문=Created!")
    @Test
    public void getQuiz1() throws Exception{
        ...
        //then
        result.andExpect(status().isCreated()).andExpect(content().string("Create!"));
    }
    @DisplayName("quiz():GET /quiz?code=2 이면 응답코드=400,응답본문=Bad Request!")
    @Test
    ...
    @DisplayName("quiz():POST /quiz?code=1 이면 응답코드=403,응답본문=Forbidden!")
    @Test
    ...
    @DisplayName("quiz():POST /quiz?code=13 이면 응답코드=200,응답본문=OK!")
    @Test
